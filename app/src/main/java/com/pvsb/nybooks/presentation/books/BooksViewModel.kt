...
import com.pvsb.nybooks.data.ApiService
    ...
    fun getBooks() {
        ApiService.service.getBooks().enqueue(object : Callback<BookBodyResponse> {
                ...
                when {
                    ...
                    response.code() == 401 -> {
                        ...
                        viewFlipperLiveData.value =
                            Pair(VIEW_FLIPPER_ERROR, com.pvsb.nybooks.R.string.books_error_401)
                    }
                    else -> {
                        viewFlipperLiveData.value =
                            Pair(
                                VIEW_FLIPPER_ERROR,
                                com.pvsb.nybooks.R.string.books_error_400_generic
                            )
                    }
                }
            }
            ...
            override fun onFailure(call: Call<BookBodyResponse>, t: Throwable) {
                viewFlipperLiveData.value =
                    Pair(VIEW_FLIPPER_ERROR, com.pvsb.nybooks.R.string.books_error_500_generic)
            }
        })
    }
